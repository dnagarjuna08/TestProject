...
mst_workstation.IsActive = 1 
AND MST_Line.IsActive=1 
and MST_Area.IsActive=1 
and  MST_WorkStation.MST_WorkStationType_Id <>1
and MST_WorkStation.WorkStationName not in ('LAconveyor')
order by MST_WorkStation.CreatedDate 
