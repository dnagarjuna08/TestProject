SELECT distinct AreaName, --LineName ,
...
from 
MST_Area 
inner join  PRODUCTION_ORDER on 
PRODUCTION_ORDER. MST_Area_Id = MST_Area.MST_Area_Id
...
INNER JOIN M_BOM ON PRODUCTION_ORDER.M_BOM_Id = M_BOM.M_BOM_Id
 inner join SAP_OutboundOrderDetail ON SAP_OutboundOrderDetail.SerialNumber = PRODUCTION_ORDER.serial_number
...
and
PRODUCTION_ORDER.CreatedOn between :StartDate and :EndDate 
    and M_BOMNumber=:RACode