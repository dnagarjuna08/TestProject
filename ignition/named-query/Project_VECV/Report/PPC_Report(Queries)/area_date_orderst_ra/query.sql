SELECT 
   distinct
    AreaName, 
    --LineName,
    M_BOMNumber as RACode,serial_number as SerialNumber,SAP_OutboundOrderResponse.MESSAGE as SAP_Message,
    CASE 
...
--INNER JOIN  
  --  MST_Line ON MST_Area.MST_Area_Id = MST_Line.MST_Area_Id
...
WHERE  
    ...
    AND SAP_OutboundOrderDetail.IsRFC = CASE
        ...
        ELSE SAP_OutboundOrderDetail.IsRFC 
    END
