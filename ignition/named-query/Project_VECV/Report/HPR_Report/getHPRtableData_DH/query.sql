...
DECLARE @WorkStationIdHD NVARCHAR(10) = :WorkStationHD; -- Selected workstation ID
DECLARE @WorkStationIdLD NVARCHAR(10) = :WorkStationLD; -- Selected workstation ID
...
FROM (
    ...
    SELECT 
        ...
        (
            ...
            WHERE MST_WorkStation.WorkStationName in (@WorkStationIdHD,@WorkStationIdLD)
