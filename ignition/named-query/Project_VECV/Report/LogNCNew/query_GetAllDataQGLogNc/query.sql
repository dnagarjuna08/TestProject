...
INNER JOIN 
    dbo.MST_OPDefinition ON dbo.MST_OPDefinition.MST_OPDefinition_Id = MST_WIOPCode.MST_OPDefinition_Id
INNER JOIN 
...
INNER JOIN MST_Line ON    MST_Line . MST_Line_Id  = TRN_OPNonConformance . MST_Line_Id 
WHERE 
    MST_Area.AreaName = :selectedArea
and 
    SerialNumber=:selectedSerialNum
and 
    MST_Line.LineName=:selectedLine
and 
    MST_WorkStation.WorkStationName = :selectedStation
and 
	TRN_OPNonConformance.CreatedDate BETWEEN :StartDate AND :EndDate
