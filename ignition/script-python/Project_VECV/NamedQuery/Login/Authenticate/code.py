...
Purpose:			 
		Functions to Get Assign Form data for Role. 
"""	
def GetAssignFormToRole(roleID):		
	...
	for row in menu_data:
	    ...
	    if menu_description not in menu_structure:
	        menu_structure[menu_description] = {
	            ...
	            "Selected":False,
	            "DropIcon": "material/arrow_drop_down"
	        }
	...
	data = system.db.runNamedQuery("Project_VECV/MenuBarNavigation/getModuleName")
	desired_order = [str(dt['ModuleName']) for dt in data ]
...
Written Date: 10/05/2024
Purpose:			 
		Functions to Get Assign Form data for User. 
"""			
