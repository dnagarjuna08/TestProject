def send_production_report():
    try:
        ...
        query_path = "Project_VECV/Report/HPR_Report/getHPRtableData_DH"  # Replace with the actual Named Query path
        params = {
            "FromDate": fromDate,
            "ToDate": toDate,
            "WorkStationHD": stationHD,
            "WorkStationLD": stationLD
        ...
        subject = "MES || DRIVE HEAD HD || HPR Report (" + fromDate + " All Shifts)"
        body = (
            "<p>Dear All,</p>"
            "<p>Please Find Attached DRIVE HEAD LINE HD HPR REPORT for date " + fromDate + " All Shifts</p>"
            + html +
