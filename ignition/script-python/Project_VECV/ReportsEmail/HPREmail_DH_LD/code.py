def send_production_report():
    try:
        ...
        query_path = "Project_VECV/Report/HPR_Report/getHPRtableData_LD"  # Replace with the actual Named Query path
        params = {
            "FromDate": fromDate,
            "ToDate": toDate,
            "WorkStation": stationLD
        }
        ...
        subject = "MES || DRIVE HEAD LD || HPR Report (" + fromDate + " All Shifts)"
        body = (
            "<p>Dear All,</p>"
            "<p>Please Find Attached DRIVE HEAD LINE LD HPR REPORT for date " + fromDate + " All Shifts</p>"
            + html +
