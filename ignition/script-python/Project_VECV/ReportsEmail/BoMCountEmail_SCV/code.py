def BoMCountEmail():
    try:
        ...
        subject = "MES || SCV AXLE SHOP || Daily BoM Tracker Report (" + fromDate + " All Shifts)"
        body = (
            "<p>Dear All,</p>"
            "<p>Please Find Attached <B>SCV AXLE Daily BoM Tracker Report</B> for date " + fromDate + " All Shifts</p>"
            + html +
