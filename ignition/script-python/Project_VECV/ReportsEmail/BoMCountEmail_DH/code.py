def BoMCountEmail():
    try:
        ...
        query_path = "Project_VECV/RaCodeCount/getData_DH_Email"  # Replace with the actual Named Query path
        params = {
            "ToDate": toDate,
            "FromDate": fromDate
        }
        ...
        for row_idx in range(row_count):
            bom = results.getValueAt(row_idx, 'DHCode')  # Assuming the column is 'BoM'
        ...
        subject = "MES || LEGACY DRIVE HEAD || Daily BoM Tracker Report (" + fromDate + " All Shifts)"
        body = (
            "<p>Dear All,</p>"
            "<p>Please Find Attached <B>Daily Legacy Drive Head BoM Tracker Report</B> for date " + fromDate + " All Shifts</p>"
            + html +
